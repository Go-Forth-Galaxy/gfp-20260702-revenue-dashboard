...
(function () {
  ...
  function renderOverall(o) {
    ...
    if (o.julyCallout) {
      ...
      document.getElementById("ov-july").innerHTML =
        ...
        money2(jc.total) + "</b> in Jul 1\u201327 \u2014 Coffee " + money2(jc.coffee) + " \u00b7 Food " +
  ...
  function renderCoffee(c) {
    ...
    document.getElementById("cf-kpis").innerHTML = [
      { label: "July MTD (1\u201327)", value: money2(c.mtdRealized), meta: pct0(mtdPct) + " of " + money(c.mtdBudget) + " budget-to-date" },
      ...
      { label: "Products Sold (Jul 1\u201327)", value: num(units.total),
